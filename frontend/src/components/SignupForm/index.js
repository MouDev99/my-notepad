...
function SignupForm({ onClose }) {
    ...
    return (
        <MDBContainer fluid className='signup-form-container'>

            <MDBRow className='d-flex justify-content-center align-items-center h-100'>
                <MDBCol col='12'>

                    <MDBCard className='bg-dark text-white py-0 my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '400px' }}>
                        <MDBCardBody className='signup-card p-5 d-flex flex-column align-items-center mx-auto w-100'>
                            ...
                            <MDBInput wrapperClass='mb-2 mx-5 w-100 form-white' labelClass='text-white' label='Username'
                                type='text' size="lg"
                                value={username}
                            ...
                            <MDBInput wrapperClass='mb-2 mx-5 w-100 form-white' labelClass='text-white' label='Email'
                                type='email' size="lg"
                                value={email}
                            ...
                            <MDBInput wrapperClass='mb-2 mx-5 w-100 form-white' labelClass='text-white' label='Password'
                            ...
                            <MDBInput wrapperClass='mb-2 mx-5 w-100 form-white' labelClass='text-white' label='Confirm password'
                                type='password' size="lg"
